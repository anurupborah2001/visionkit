...
class HairSegmentation:
  ...
  def blend_hair_color(self, bgr_image: np.ndarray, color=(180, 0, 255), alpha=0.5) -> np.ndarray:
    ...
    out[hair_region] = (
      (1 - alpha) * bgr_image[hair_region].astype(np.float32) +
  ...
  def visualize(self, bgr_image: np.ndarray, color=(180, 0, 255), alpha=0.5) -> np.ndarray:
  ...
  def draw_hair_contours(self, bgr_image: np.ndarray, color=(0, 255, 255), thickness=2) -> np.ndarray:
  ...
  def apply_gradient_color(self, bgr_image: np.ndarray,
                           color1, color2) -> np.ndarray:
  ...
  def apply_highlights(self, bgr_image: np.ndarray,
                       highlight_color=(255, 255, 200),
                       intensity=0.4) -> np.ndarray:
